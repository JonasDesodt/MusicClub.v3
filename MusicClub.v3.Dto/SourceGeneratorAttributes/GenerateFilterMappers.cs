namespace MusicClub.v3.Dto.SourceGeneratorAttributes
{
    ...
    internal class GenerateFilterMappers(Type iModel) : Attribute
    {
        ...
        public const string ForeignKeyReplacePattern = @$"(?<=\S){GeneratorConstants.Id}$";//@$"(?<=\S){GeneratorConstants.Id}(?!.+{GeneratorConstants.Id})";
